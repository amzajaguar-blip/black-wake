...
new_detection_logic = """        var newDetection = state.detection
        ...
        newDetection = kotlin.math.min(1f, newDetection + dt * totalAccumulation)
        ...
        newDetection = kotlin.math.max(0.0f, newDetection - dt * decayRate)"""
